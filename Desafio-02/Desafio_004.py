...
def validate_numero_telefone(phone_number):
    ...
    # A função 're.match()' retorna um objeto 'match' se houver correspondência no início da string, caso contrário, retorna 'None'.
    if re.match(pattern, phone_number):  
        # Retorna que o número de telefone é válido:
        return "Número de telefone válido."
    else:
        # Retorna caso o número de telefone seja inválido:
