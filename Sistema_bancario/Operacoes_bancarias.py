...
while True:
    ...
    # LEN PARA VERIFICAR QUANTIDADE DE CARACTERES INSERIDOS NO CÓDIGO
...
while True:
    # LOPPING INFINITO ATE QUE SEJA EXATAMENTE 6 DIGITOS
...
while True:  # Loop infinito
    ...
    if opcao == "D":
        ...
        if excedeu_saldo:
            ...
            print(
                "Não é possível realizar esta operação! Número de saques diários excedidos.")
        elif valor > 0:
            saldo -= valor
